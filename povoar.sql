...
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (6,3,3,"Rua D.Pedro III, s/n",133, 40, 3, NULL, 7, 2,1);
